...
my_entry = Entry(root, font=("Baskerville Old Face", 22), width=24)
...
def delete_crossed():
	...
	while count < my_list.size():
		if my_list.itemcget(count, "fg") == "#FF0000":
